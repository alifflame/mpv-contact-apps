...
export default function UpdateContactForm(props) {
    ...
    return(
        <>
            <button onClick={()=>detailContact(props.idContact)} className="btn 
            btn-dark" type="button" data-bs-toggle="modal"
            data-bs-target="#formUpdateContact">Update</button>
                    ...
                    <div className="modal-header">
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="form-group mt-1">
                                    ...
                                    target.value)} type="text" className="form-control"/>
                                </div>
                                <div className="form-group mt-1">
                                    <label htmlFor="email">Email</label>
                                    <input value={email} onChange={(e)=>setEmail(e.
                                    target.value)} type="email" className="form-control"/>
                                </div>
                                <div className="form-group mt-1">
                                    <label htmlFor="phone">Phone Number</label>
                                    <input value={phone} onChange={(e)=>setPhone(e.
                                    target.value)} type="number" className="form-control"/>
                                </div>
                                <div className="form-group mt-1">
